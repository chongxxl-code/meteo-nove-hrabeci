...
def rain_totals():
    ...
    return {'rain_7d_mm':round(sums[7],1),'rain_14d_mm':round(sums[14],1),'rain_30d_mm':round(sums[30],1),'latest_observation_utc':latest.isoformat() if latest else None,'interval_counts':counts}
